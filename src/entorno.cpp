...
bool entornoCargarConfiguracion ( int &numFilas, int &numColumnas, int &comoIniciar, int &filasIniciales,int m[MAX_FILAS][MAX_COLUMNAS]){
	bool leido;
	int i, j;
	ifstream fEntrada;
	string cadena, cad;
...
void entornoResaltarColumna(int columna) {
    cout << "Columna resaltada: " << columna << endl;
}
